...
teeth = 95;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
translate([0,0,-5])cylinder(r=45/2, h=32, $fn=40);
translate([0,-53/2,-2])cylinder(r=2.2/2, h=60, $fn=40);
translate([0,+53/2,-2])cylinder(r=2.2/2, h=60, $fn=40);
translate([-53/2,0,-2])cylinder(r=2.2/2, h=60, $fn=40);
translate([+53/2,0,-2])cylinder(r=2.2/2, h=60, $fn=40);

translate([0,-53/2,8])cylinder(r=5/2, h=60, $fn=40);
translate([0,+53/2,8])cylinder(r=5/2, h=60, $fn=40);
translate([-53/2,0,8])cylinder(r=5/2, h=60, $fn=40);
translate([+53/2,0,8])cylinder(r=5/2, h=60, $fn=40);
