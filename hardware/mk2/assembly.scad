...
color("red")motor(t=[0,0,-34],r=[0,0,0]);
color("green")translate([0,0,+0])rotate([0,0,0])pfeilrad (modul=1, zahnzahl=15, breite=7, bohrung=5, eingriffswinkel=20, schraegungswinkel=20, optimiert=true);
}

gehauseUnten(t=[0,0,-15],r=[0,0,0], ex=12.4);
