...
teeth = 78;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
translate([0,0,-10])cylinder(r=15,h=70);
translate([+14,+14,-10])cylinder(r=1.5,h=40, $fn=30);
translate([-14,+14,-10])cylinder(r=1.5,h=40, $fn=30);
translate([-14,-14,-10])cylinder(r=1.5,h=40, $fn=30);
translate([+14,-14,-10])cylinder(r=1.5,h=40, $fn=30);
}
