...
: ${AMENT_CURRENT_PREFIX:="/server_ws/install/run_ompl_constrained_planning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/run_ompl_constrained_planning/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/run_ompl_constrained_planning/environment/path.sh"
