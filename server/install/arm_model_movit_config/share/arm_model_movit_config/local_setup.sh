...
: ${AMENT_CURRENT_PREFIX:="/server_ws/install/arm_model_movit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_model_movit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_model_movit_config/environment/path.sh"
