...
: ${AMENT_CURRENT_PREFIX:="/server_ws/install/run_move_group"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/run_move_group/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/run_move_group/environment/path.sh"
