...
: ${AMENT_CURRENT_PREFIX:="/server_ws/install/moveit_arduino_arm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_arduino_arm/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_arduino_arm/environment/path.sh"
